...
async def start(_, message: Message):
    await message.reply_text(
        ...
        reply_markup=InlineKeyboardMarkup(
            ...
            InlineKeyboardButton("💬 Channel", url="https://t.me/MznStudios"),
...
@Client.on_message(filters.command(["start", "start@MznGroupMusicPlayBot"]) & ~filters.private & ~filters.channel)
async def gstart(_, message: Message):
    await message.reply_text(
        text="**Music Bot Is Online ✅**",
        reply_markup=InlineKeyboardMarkup(
            [[
            InlineKeyboardButton(text="🎙️ Support Group 🎙️", url="https://t.me/MznSupport")
            ]]
        )
    )


@Client.on_message(filters.command(["cmdlist", "start@MznGroupMusicPlayBot"]) & filters.private & ~filters.channel)
